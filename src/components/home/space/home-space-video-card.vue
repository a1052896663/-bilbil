      ...
      <div>
        ...
        <div  id="home-space-video-card-image" @click.stop="ToVideoView(Date2.videoId)">
          <van-image
              ...
              fit="cover"
              :src="Date2.videoImagSrc"

              radius="4rem"
          />
          <van-icon  class="home-space-video-card-image-play" size="20rem" name="play-circle-o" />
          <div class="home-space-video-card-image-m">
...
@media screen  and (min-device-width: 200px) and (max-device-width:5000px) {
  ...
  .home-space-video-card-image-play{
    position: relative;
    z-index: 90;
    top: -39rem;
    left: 35rem;
